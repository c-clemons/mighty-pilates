...
SERVICE_TYPE_BUCKETS = {
    ...
    # All previously fell through fillna('401001') → Machine in the JE, so this is
    # a labelling fix, not a JE change.
    "Staff Class":                 "Machine",
    "Other":                       "Machine",
...
def generate_gl_export(conn, start_date: str, end_date: str, output_dir: str = None) -> str:
    ...
    # ClassPass revenue — Cat-authoritative override when available (RESERVATIONS
    # lags at close time), otherwise the live RESERVATIONS feed.
